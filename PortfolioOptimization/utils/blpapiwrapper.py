...
class BLP():
    ...
    def bds(self, strSecurity='US900123AL40 Govt', strData='PX_LAST', strOverrideField='', strOverrideValue=''):
        request = self.refDataSvc.createRequest('ReferenceData')
        request.append('securities', strSecurity)
        request.append('fields', strData)
...
def streamPatternExample():
    stream = BLPStream('CT5 Govt', ['BID', 'ASK'], 0, 1)
